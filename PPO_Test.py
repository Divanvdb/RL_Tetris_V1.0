...
agent = Agent(version=version_, input_dims=4, n_actions=2)
    ...
    for e in range(episodes):
        ...
        for _ in range(time_steps):
            ...
            if done:
                ...
                print(f'Game:\n\tReward: {total_reward}\n\tLenght: {game_lenght}')
                if logging:
                    agent.episodic_log(total_reward=total_reward, episode_lenght=game_lenght, total_steps=i)
                total_reward = 0
                game_lenght = 0 
