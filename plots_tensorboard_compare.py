...
sns.regplot(x = "Step", y = "Value",data=info_len1, order=3, color='r', 
            robust=False, scatter=False, ax=axes[0])
sns.regplot(x = "Step", y = "Value",data=info_len2, order=5, color='b', 
            robust=False, scatter=False, ax=axes[0]).set(title='Episodic Lenght', 
                                                         xlabel= 'Episode', ylabel= 'Game Lenght')


sns.regplot(x = "Step", y = "Value",data=info_rew1, order=3, 
            robust=False, scatter=False, ax=axes[1], color='r')
sns.regplot(x = "Step", y = "Value",data=info_rew2, order=5, 
            robust=False, scatter=False, ax=axes[1], color='b').set(title='Episodic Reward', 
                                                         xlabel= 'Episode', ylabel= 'Game Reward')
plt.legend(labels=["e-Greedy","Deviation","No e-Term","Deviation"], loc='upper left')
sns.set(style='dark',)
